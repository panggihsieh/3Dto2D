  ...
  const pages = {
    basic: {
      ...
      text: {
        ...
        "#materialTitle": ["材料與預覽", "Material and Preview", "Material und Vorschau", "Material und Vorschau"],
        ...
        ".manual-list li:nth-child(5)": ["檢查右側預覽與提示，確認黑色內尺寸、灰色 offset 與紅色切割線狀態。", "Check the preview and notices, then confirm the black inner dimensions, gray offset guides, and red cutline state.", "Prüfen Sie Vorschau und Hinweise und kontrollieren Sie schwarze Innenmaße, graue Offset-Hilfslinien und rote Schnittlinien.", "Prüfen Sie Vorschau und Hinweise und kontrollieren Sie schwarze Innenmaße, graue Offset-Hilfslinien und rote Schnittlinien."],
